        ...
        <v-card class="modal">
            ...
            <v-card-actions class="d-flex justify-space-between">
                ...
                <v-btn
                    ...
                    @click="actionDeleteContactVarejao"
                    >Excluir</v-btn
                >
            </v-card-actions>
        </v-card>
...
<script>
    ...
    export default {
        name: "DeleteContactVarejaoDialog",
        ...
        methods: {
            ...mapActions("Varejao", ["deleteContactVarejao"]),
            ...mapActions(["toggleSnackbar"]),
            async actionDeleteContactVarejao() {
                try {
                    const response = await this.deleteContactVarejao(
                        this.contact.id
                    );
