...
<script>
    ...
    import DeleteContactVarejaoDialog from "@/modules/varejao/views/components/DeleteContactVarejaoDialog";

    export default {
        name: "VarejaoMenuItem",

        components: {
            DeleteContactVarejaoDialog
        },
